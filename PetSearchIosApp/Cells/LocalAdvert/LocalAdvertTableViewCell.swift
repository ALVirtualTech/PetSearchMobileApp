//
//  LocalAdvertTableViewCell.swift
//  PetSearchIosApp
//
...
class LocalAdvertTableViewCell: UITableViewCell {

    @IBOutlet weak var advertImageView: UIImageView!
    @IBOutlet weak var deleteFromLocalStorageBtn: UIImageView!
    ...
    func deleteAdvert(_ sender: Any?) {
    ...
    func setup(from advert: Advert) {
        ...
        deleteFromLocalStorageBtn.isUserInteractionEnabled = true
        deleteFromLocalStorageBtn.addGestureRecognizer(tapGestureRecognizer)
    }
